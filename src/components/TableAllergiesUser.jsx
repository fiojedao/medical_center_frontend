...
function TableAllergiesToolbar(props) {
  ...
  /* const { mrUser, errorData2, loadedData2 } = useCallApiDetail({
        endpoint: `medicalrecord/getByUser/'${id}'`,
        action: "GET",
        start:true,
    });
...
export default function TableAllergies() {
    ...
    const { responseData, errorData, loadedData } = getAllergies({
        endpoint: "allergies/getDontByUser/'u00001'",
        //endpoint: "allergies/getDontByUser/'${id}'`,
        action: "GET",
        start,
    });
