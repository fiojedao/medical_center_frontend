...
export function FormDiseases() {
  ...
  const onError = (errors, e) => {
    if (esCrear ) {
      toast.error("Error, debe de completar los espacios requeridos para crear la enfermedad");
    }else{
      toast.error("Error, no se ha podido actualizar la enfermedad, debe completar los espacios requeridos");
    }  
  };
  ...
  useEffect(() => {
    if (responseData != null) {
      ...
      if (!esCrear && data) {
        ...
        toast.success("Enfermedad " + nombre + " actualizada correctamente");
      } else {
        toast.success(
          "Enfermedad " +
          responseData[0].name +
